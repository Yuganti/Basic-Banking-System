...
<body style="background-color:lavender;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <p style="color:white;">This Present website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Yuganti Chithore</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Smt. Kashibai Navale College of Engineering,Pune</b></p>
    </center>
